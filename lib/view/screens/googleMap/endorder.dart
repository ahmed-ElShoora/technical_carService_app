...
class EndMap extends StatelessWidget {
  ...
  final double lating;
  final double lnging;
  EndMap({super.key, required this.id, required this.lat, required this.lng, required this.lating, required this.lnging});
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: CustomButton(onPress: (){
                        controller.endOrder(id);
                      },text: 'تم انتهاء العمل',),
                    ),
                  ),
                ]
            );
